// Run with: node setup2.mjs
import fs from "fs";

const script = `import { createClient } from "@supabase/supabase-js";
import fs from "fs";
...
fs.writeFileSync("scripts/import_to_supabase.mjs", script);
console.log("✅ Created scripts/import_to_supabase.mjs");
